...
/**
 * DAO for table "todo_user".
 */
public class ToDoUserDao extends AbstractDao<ToDoUser, Void> {

    public static final String TABLENAME = "todo_user";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_todo_user_todo_id_user_id ON \"todo_user\"" +
                " (\"todo_id\" ASC,\"user_id\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"todo_user\"";
        db.execSQL(sql);
    }
